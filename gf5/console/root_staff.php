...
<title><?php echo $PageTitle='Staff Listing - '.$AcctCompanyName;?></title>
...
<div id="mainWrap">
	...
	<a href="root_offices.php">View Office List</a>
	<br />

	<?php require('components/comp_60_staff_list_v110.php');?>
