...
if(!($agent=q("SELECT
u.un_firstname FirstName, u.un_middlename MiddleName, u.un_lastname LastName, un_email Email, Cell, Address, City, State, Zip, Phone
FROM bais_universal u, bais_staff s
WHERE u.un_username=s.st_unusername AND un_username='$Agents_username'", O_ROW)))exit('Unable to locate agent info');
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />

<title><?php echo $PageTitle='Agent Oustanding Invoices';?></title>
...
<div id="mainBody">
<h1>Outstanding Invoices for <?php echo $agent['FirstName'] . ' ' . $agent['LastName']?></h1>
<?php if($agent['Cell'])echo 'Cell: '.$agent['Cell'].'<br />';?>
<?php 
if($agent['Email']){
	?><a href="mailto:<?php echo $agent['Email']?>" title="email this agent"><?php echo $agent['Email']?></a><?php
}
?>

<?php require($COMPONENT_ROOT.'/comp_255_agentinvoices.php');?>
