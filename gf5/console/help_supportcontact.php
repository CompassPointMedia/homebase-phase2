...
<title><?php echo $PageTitle='Support and Contact, Trouble Tickets System - '.$AcctCompanyName;?></title>
...
<div id="mainWrap">
	...
	<a href="help_contact.php" onclick="return ow(this.href,'l1_supportrequest','700,700');">Add a trouble ticket or request</a>	
	
	<?php
	require('components/comp_911_tickets.php');
	?>
