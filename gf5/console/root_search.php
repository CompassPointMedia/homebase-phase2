...
<title><?php echo $PageTitle='Search for Properties - '.$AcctCompanyName?></title>
...
<div id="mainWrap">
	...
	<form name="form1" id="form1" action="resources/bais_01_exe.php" method="get" target="w2">
	<?php require('components/comp_90_searchform_v100.php');?>
