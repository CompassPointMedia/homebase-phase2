...
<div id="mainBody">
<?php
require('components/comp_975_exportmanager.php');
?>

    <br />
<br />
<!--
<input type="submit" name="Submit" id="setRecords" value="Set Records" />
-->
<input type="submit" name="Submit" id="setRecordsExport" value="Create Batch or Download/Upload" />
&nbsp;&nbsp;
<input type="button" name="Button" value="Close" onclick="if(confirm('Sure you want to close this window?'))window.close()" />
</div>
<div id="footer">
&nbsp;&nbsp;
</div>
