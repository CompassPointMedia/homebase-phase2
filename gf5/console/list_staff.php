...
<title><?php echo $PageTitle='List Staff - '.$AcctCompanyName?></title>
...
<div id="mainWrap">
	...
	<?php require($_SERVER['DOCUMENT_ROOT'].'/Library/gf_header_login_003.php');?>


	
	<div id="mainBody">
							
	<h3><img src="/images/i/addr_26x27.gif" width="26" height="27">&nbsp;List Staff</h3>
	...
	<?php }?>
</ul><?php require('components/comp_60_staff_list_v110.php');?>
