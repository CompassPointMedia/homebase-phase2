...
<div id="mainWrap">
	...
	<div id="mainBody">
             <h3> You are currently 
              logged in as: 
              <?php echo $_SESSION['admin']['firstName'].' '.$_SESSION['admin']['lastName'].' ('.sun().')';?>
</h3>
                  <a href="/gf5/console/home.php">Click here to go to the Intranet Home Page</a>. <br />
              <br />
              <a href="/gf5/console/login/index.php?logout=1">Click 
              here to log out</a>
                  <p><b>Or to log in under a different user name, submit the following:</b> 
                  </p>
                  <form action="/gf5/console/login/index.php" method="post" name="form1" id="form1">
                    <table width="56%">
                      <tr> 
                        <td>Account Name or Email:</td>
                        <td> 
                          <input type="text" id="UsrName" name="UN" value="<?php echo $UN;?>" />
                          <script language="javascript" type="text/javascript">g('UsrName').focus()</script>
                        </td>
                      </tr>
                      <tr> 
                        <td>Password:</td>
                    ...
                    <br />
                    For a forgotten password <a href="../login/forgot_password.php">click 
                    here</a>. 
                  </form>
                  <br />
                  </div>
