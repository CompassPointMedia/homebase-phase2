...
<title><?php echo $PageTitle='Help Main Documentation Page - '.$AcctCompanyName?></title>
...
<style type="text/css">
<?php foreach($ageGroups as $v){ ?>
.ag_<?php echo strtolower($v[0])?>{
	background-color:<?php echo $v[1]?>;
	}<?php } ?>
</style>
...
//2010-02-15 added to make main nav menu appear before long lists loaded
var menuBeforeList=true;
...
<div id="leftNav">
<?php require($_SERVER['DOCUMENT_ROOT'].'/gf5/console/gf_help_proto.php');?>

</div>
<div id="mainContent">
<h1 class="nullTop">Help Main Documentation Page</h1>
