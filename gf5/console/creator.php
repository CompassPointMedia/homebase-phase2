...
<title><?php echo $PageTitle='Creator - '.$AcctCompanyName;?></title>
...
<div id="datasetList">
	...
	<tfoot>
	<tr>
		<td colspan="100%">[<a href="dataset_creator.php" title="create new dataset" onclick="return ow(this.href,'l1_creator','800,700');">create new</a>]</td>
	</tr>
	</tfoot>
	<tbody>
	<?php
	if($a=q("SELECT * FROM system_datasets", O_ARRAY_ASSOC))
	foreach($a as $n=>$v){
		?><tr id="">
		<td>[<a href="dataset_creator.php?Location=<?php echo urlencode($v['Location']);?>" title="edit this dataset" onclick="return ow(this.href,'l1_creator','800,700');">edit</a>]</td>
