...
$ids=q("SELECT ID FROM finan_headers WHERE HeaderType='Payment'",O_COL);
...
if(strlen($$object) || $Payments_ID=q("SELECT ID FROM finan_headers, finan_payments WHERE ID=Headers_ID AND ID='".$$object."'", O_VALUE)){
	...
	if($a=q("SELECT a.*, b.Types_ID FROM finan_headers a, finan_payments b WHERE a.ID=b.Headers_ID AND a.ID='".$$object."'",O_ROW)){
		$mode=$updateMode;
		@extract($a);
...
<div id="mainBody">
<div class="suite1">
<?php require('components/comp_70_payments_v100.php');?>
</div>
