...
if(true)$datasetDebug['query']=md5($MASTER_PASSWORD);
...
$datasetDefaultParams[$dataset]['showVoids']=0;
...
lt.Leases_ID=l.ID $dueStatusQuery $statusQuery";
...
<div class="fr">
	...
	<div class="frb">
	<label>
	<input type="checkbox" name="IncludeVoids" value="1" <?php echo $voidsShowing ? 'checked':''?> onclick="toggleVoids(this.checked);" /> 
	Include Voids 
	</label>
	</div>
	<div class="frb">
...
if(!$refreshComponentOnly){
	...
	function toggleVoids(n){
		ow('/gf5/console/resources/bais_01_exe.php?mode=refreshComponent&component=<?php echo $datasetComponent?>&submode=toggleVoids&toggle='+(n?1:0),'w2');
	}
	</script>
<?php
}
